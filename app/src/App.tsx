...
const uiText = {
  "zh-CN": {
    ...
    modelTitle: "模型配置",
    modelSubtitle: "OpenAI-compatible API。桌面版 API Key 会保存到系统凭据库；浏览器版仅保存在当前会话。",
    providerName: "供应商名称",
  ...
  "en-US": {
    ...
    modelSubtitle: "OpenAI-compatible API. The desktop app stores API keys in the OS credential store; the browser fallback keeps them only for the current session.",
